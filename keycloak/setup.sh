...
redirectVar="[\"http://${swarmhost}:8080/*\", \"http://${swarmhost}:443/*\", \"http://${swarmhost}:80/*\", \"http://${swarmhost}/*\"]"
webOrigins="[\"http://${swarmhost}:80\", \"http://${swarmhost}:443\", \"http://${swarmhost}:8072\", \"http://${swarmhost}/*\"]"
