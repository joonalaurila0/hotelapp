...
redirectVar="[\"http://${swarmhost}:8080/*\", \"https://${swarmhost}:443/*\", \"http://${swarmhost}:80/*\", \"https://${swarmhost}/*\"]"
webOrigins="[\"http://${swarmhost}:80\", \"https://${swarmhost}:443\", \"http://${swarmhost}:8072\", \"https://${swarmhost}/*\"]"
